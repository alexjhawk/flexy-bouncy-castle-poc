# Ewon Flexy Bouncy Castle Proof of Concept Project Contribution Guidelines
...
project's [Code of Conduct](https://github.com/hms-networks/flexy-bouncy-castle-poc/blob/main/CODE_OF_CONDUCT.md).
...
existing [Issues](https://github.com/hms-networks/flexy-bouncy-castle-poc/issues)
or [Discussions](https://github.com/hms-networks/flexy-bouncy-castle-poc/discussions) that may help.
In case you've found a suitable issue or discussion and still need clarification, you may comment
directly on the issue or discussion. It is also advisable to search the internet for answers.

If you then still have a question or need clarification, you may create
a [new discussion](https://github.com/hms-networks/flexy-bouncy-castle-poc/discussions/new)
or [new issue](https://github.com/hms-networks/flexy-bouncy-castle-poc/issues/new) and provide as
much context and detail as possible.
...
We use GitHub issues to track bugs and errors. If you run into an issue with the project, please
create a [new issue](https://github.com/hms-networks/flexy-bouncy-castle-poc/issues/new) with the
...
We use GitHub issues to track feature and enhancement requests. If you'd like to suggest a feature
or enhancement, please create
a [new issue](https://github.com/hms-networks/flexy-bouncy-castle-poc/issues/new) with the following
in consideration:
...
- Read the [Documentation](https://hms-networks.github.io/flexy-bouncy-castle-poc/docs) carefully to
  find out if the functionality is already covered.
- Perform a search for
  existing [Issues](https://github.com/hms-networks/flexy-bouncy-castle-poc/issues)
  or [Discussions](https://github.com/hms-networks/flexy-bouncy-castle-poc/discussions) to see if
  the feature or enhancement has already been suggested.
