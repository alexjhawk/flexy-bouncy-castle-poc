...
This project includes basic support for unit testing via the JUnit 3.8.1 test framework. A test
class has been included in this project at `src/test/java/PocTest.java`. For detailed information
about JUnit 3.8.1 and its capabilities, please refer
